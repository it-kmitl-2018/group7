...
public class TaxInvoiceControllerTests {
	...
	@Test
	public void shouldGotoGenerateIndividualTradeProductInstanceXML() throws Exception {
		this.mockMvc.perform(get("/generate/individualTradeProductInstance")).andExpect(status().isOk());
	}
}