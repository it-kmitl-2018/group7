...
public class ReceiverInformationTests {
	...
	public void checkOutputMatch() {
		...
		receiverInformation.setEmail("test@mail.com");
		receiverInformation.setTelePhone("02-5255433");
		...
		Assert.assertEquals(receiverInformation.getEmail(), "test@mail.com");
		Assert.assertEquals(receiverInformation.getTelePhone(), "02-5255433");
