...
public enum TaxType {
    ...
    STAMP_DUTY ("BOL", "Stamp duty"),
    AGRICULTURAL_LEVY ("CAP", "Agricultural levy"),
    CAR_TAX ("CAR", "Car tax"),
    PAPER_CONSORTIUM_TAX ("COC", "Paper consortium tax"),
    ...
    private @Getter String taxCode;
    private @Getter String taxName;
    
    TaxType(String taxCode, String taxName) {
